...
## 1. Request Parameters  
    ...
    Date Completed: 2021-03-29T14:53:09.600009  

    Id: 121c1562-dac9-4134-9a9d-33837e108cdd  
    ...
    Details:  
        ...
        Layers:  
                ...
                LST_Day_1KM (MYD21A2.006)  
                LST_Night_1KM (MYD21A2.006)  
...
- slc-lst-8day-MYD21A2-006-metadata.xml
- slc-lst-8day-granule-list.txt
- slc-lst-8day-request.json
- MYD21A2-006-QC-Day-lookup.csv
- MYD21A2-006-QC-Night-lookup.csv
- MYD21A2-006-QC-Day-Statistics-QA.csv
- MYD21A2-006-QC-Night-Statistics-QA.csv
- MYD21A2-006-Statistics.csv

**Data Files:**  

Number of Extracted Data Files: 1  
Total Size of Extracted Data Files: 59.73 MB  
...
- Hulley, G. (2017). MYD21A2N MODIS/Aqua Land Surface Temperature/3-Band Emissivity 8-Day L3 Global 1km SIN Grid V006. NASA EOSDIS Land Processes DAAC. Accessed 2021-03-29 from https://doi.org/10.5067/MODIS/MYD21A2.006. Accessed March 29, 2021.

## 10. Software Citation  

AppEEARS Team. (2020). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.57. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed March 29, 2021. https://lpdaacsvc.cr.usgs.gov/appeears
